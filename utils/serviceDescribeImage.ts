...
export const serviceDescribeImage = async (
    imageDataUrl: string, 
    history: ImageDescription[],
    croppedSelectionDataUrl?: string
    ...
    if (!base64Data) {
        ...
        return {
            selectionDescription:"user selected a region to enhance",
            imageDataUrl: croppedSelectionDataUrl,
...
`
    ...
    try {
        ...
        data.imageDataUrl = croppedSelectionDataUrl;
        return data;
    } catch (error) {
